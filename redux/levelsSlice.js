...
const initialState = {
  levels: [
    ...
    new Level(36, 'מח', 'הִלְכוֹת בְּרָכוֹת עַל מַאֲכָלִים מֵחֲמֵשֶׁת מִינֵי דָּגָן', false),
    new Level(37, 'לו', 'הלכות מליחה', false),
    new Level(38, 'מט', 'דִּין בִּרְכַּת הַיַּיִן וּבִרְכַּת הַטּוֹב וְהַמֵּטִיב', false),
    new Level(39, 'נ', 'כְּלָלִים בִּבְרָכָה רִאשׁוֹנָה מִבִּרְכוֹת הַנֶּהֱנִין', false),
    new Level(40, 'נא', 'כְּלָלִים בִּבְרָכָה אַחֲרוֹנָה', false),
    new Level(41, 'ס', 'דִּין מִי שֶׁרוֹצֶה לֶאֱכֹל אוֹ לִשְׁתּוֹת קֹדֶם הַסְּעֻדָּה', false),
